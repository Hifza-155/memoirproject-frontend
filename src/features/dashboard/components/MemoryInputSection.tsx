      ...
      <div className="relative">
        ...
        {activeInput === "none" && (
          <div className="flex flex-col items-center justify-center py-10 space-y-8">
            ...
            {/* Comfortable Grid with Solid White Cards */}
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 sm:gap-10 pt-4 w-full max-w-xl">
              
              {/* 1. WRITTEN REFLECTION (Restored Paper Fold shape) */}
              <motion.button
                type="button"
              ...
              {/* 2. VOICE NOTE (Restored Pill shape) */}
              <motion.button
                type="button"
              ...
              {/* 3. PHOTOGRAPH (Restored Tilted Polaroid shape) */}
              <motion.button
                type="button"
              ...
              {/* 4. COMBINED MEMORY (Restored Double-border Tilted shape) */}
              <motion.button
                type="button"
              ...
              <div className="relative space-y-6">
                ...
                <form onSubmit={handleLocalSubmit} className="space-y-6">
                  ...
                  <motion.div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    {/* HEADING PIECE (Restored organic puzzle corner radius) */}
                    <div 
                    ...
                    {/* DATE PIECE (Restored organic puzzle corner radius) */}
                    <div 
                      className="p-8 bg-white border-2 border-stone-300 shadow-md relative flex flex-col justify-between"
                    ...
                    {/* CONTENT PIECE (Restored organic puzzle corner radius) */}
                    <div 
                    ...
                    >
                      <div className="space-y-3 w-full">
                          ...
                          <div>
                            {isTextExpanded ? (
                              <textarea
                                ...
                                placeholder={activeInput === "combined" ? "Add reflection text or view voice transcription..." : "Write your story here with care..."}
                                rows={6}
                                autoFocus
                        ...
                        {(activeInput === "audio" || activeInput === "combined") && (
                          <div className="flex items-center gap-4 py-4 bg-white" onClick={(e) => e.stopPropagation()}>
                            <button type="button" className="w-12 h-12 rounded-xl bg-memory-primary text-memory-light flex items-center justify-center shadow-md shrink-0 hover:bg-memory-primary/90 transition-colors">
                              <Mic size={18} />
                            </button>
                            <span className="font-sans text-[15px] font-medium text-stone-600">
                              {activeInput === "combined" ? "Record voice note (transcription auto-fills text)" : "Tap to record voice note"}
                            </span>
                          </div>
                        )}
                        ...
                        {(activeInput === "media" || activeInput === "combined") && (
                          <div className="space-y-2 bg-white pt-2" onClick={(e) => e.stopPropagation()}>
                            <div className="relative border-2 border-dashed border-stone-300 rounded-xl bg-stone-50/50 flex items-center justify-center p-6 gap-3 cursor-pointer hover:bg-stone-100 transition-colors">
                  ...
                  {/* Submission CTA - Kept modern/structural as per Signup */}
