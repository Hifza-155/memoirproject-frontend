    ...
    <section className="relative flex min-h-screen items-center justify-center overflow-hidden bg-memory-bg px-6 py-12 text-memory-primary font-sans">
      ...
      >
        ...
        <div className="pt-14 text-center">
          ...
          <div className="group relative mx-auto mt-10 h-[340px] w-full max-w-[430px]">

            {/* TOP-RIGHT POPUP */}
            <div
              className="
                absolute right-0 top-0 z-40
                translate-x-[-45px] translate-y-[55px]
                scale-90 opacity-0
                pointer-events-none
              ...
              "
            >
              <div className="relative w-[245px] rounded-2xl rounded-bl-md border border-memory-border bg-white px-5 py-4 text-left shadow-xl">
            ...
            <div
              className="
                ...
                translate-x-[45px] translate-y-[-35px]
                scale-90 opacity-0
                pointer-events-none
                transition-all duration-500 ease-out
                group-hover:pointer-events-auto
              ...
              "
            >
              <div className="relative w-[205px] rounded-2xl rounded-tr-md border border-memory-border bg-white px-5 py-4 text-left shadow-xl">
                <p className="font-serif text-[11px] text-memory-muted">
                  Maybe they remember...
                </p>
          ...
          <motion.p
            ...
            className="mx-auto max-w-sm font-serif text-[14px] italic leading-6 text-memory-muted"
          >
            Maybe they remember the same day differently.
            <br />
            Maybe they remember something you never knew.
          </motion.p>
